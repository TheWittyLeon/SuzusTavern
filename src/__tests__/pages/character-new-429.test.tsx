  ...
  class: [
    {
      ...
      data: {
        ...
        // TAV-WIZARD-HOMEBREW-CASTERS merge (post20 staging + wizard-homebrew-
        // casters): isCaster is now derived from this block alone
        // (catalogItemToClass -> casterKindFromSpellcasting), not from the
        // legacy `spellcasting_ability` field above — without it wizard would
        // resolve isCaster:false, skip the Spells step, and this suite's
        // "silent create fires on Equipment -> Spells" premise would never
        // exercise (the create would fire from Review instead, on a
        // different fetch route than the one under test here).
        spellcasting: { ability: 'intelligence', progression: 'full', prepares_from_spellbook: true },
      },
    },
  ],
  background: [
